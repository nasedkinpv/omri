...
class ModelConfigurationManager {
    ...
    func buildRequestParameters(
        ...
        guard config.modelType == .transformation else {
            print("Warning: buildRequestParameters called with transcription model: \(model), using fallback")
    ...
    func buildTranscriptionParameters(
        ...
        guard config.modelType == .transcription else {
            print("Warning: buildTranscriptionParameters called with transformation model: \(model), using fallback")
